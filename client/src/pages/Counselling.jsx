...
const Counselling = () => {
  ...
  const [selectedCollege, setSelectedCollege] =
    useState(
      selectedCollegeFromUrl || ""
    );

  const [selectedBranch, setSelectedBranch] =
    useState(
      selectedBranchFromUrl || ""
    );
  ...
  const loadApplication = async () => {
    try {
      ...
      console.error(
        "Failed to load counselling application:",
        err
      );
  ...
  const addPreference = () => {
    ...
    if (!college) {
      setError(
        "Selected college could not be found."
      );
      return;
    }
        ...
        <header className="counselling-header">
          <div>
            ...
            <p>
              ...
              details, choose college
              preferences, lock them and
