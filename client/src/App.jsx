        ...
        <div className="section-container">
          ...
          <div className="search-layout">
            ...
            <div className="search-information">
              ...
              <p>
                Search our college directory and explore
        ...
        <div className="section-container">
          ...
          <div className="campus-grid">
            ...
            <div className="campus-content">
              ...
              <p>
                Compare available academic information,
                discover branches and understand the options
                available before beginning your counselling
                journey.
              </p>
  ...
  return (
    <main className="simple-page">
      ...
      <div className="simple-card">
        ...
        <p>
          Manage counselling applications, colleges,
